    ...
    return(
        <main className="main">
            <section className="image-section">
                <PagePhoto
                    imageUrl="/images/heros/speed-sign.jpg"
            ...
            <section className="main-information">
                ...
                <p>
                    <span className="first-sentence-span">Welcome to the Ilketshall St Margaret Parish Meeting page.</span> Click on the link to read the <a href="/docs/parishCouncilDocs/Constitution_2022.pdf" target="_blank">Ilketshall St Margaret Parish Meeting Constitution.</a>
                </p>
                <p>
                    To see the minutes of the last meeting click on the link below:<br />
                    <a href={`/docs/parishCouncilDocs/minutes/${parishMeetingMins.urlFragment}`} target="_blank">Meeting {parishMeetingMins.number}: {parishMeetingMins.title}</a>
                </p>
            </section>
        </main>
    )
